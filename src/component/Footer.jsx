...
const Footer = () => {
  const cards = [
    ...
    { id: 5, image: 'https://preview.colorlib.com/theme/feliciano/images/insta-5.jpg', title: 'Grilled Beef with potatoes', description: 'Meat, Potatoes, Rice, Tomatoe', price: '$25' },
    { id: 6, image: 'https://preview.colorlib.com/theme/feliciano/images/insta-6.jpg', title: 'Grilled Chicken with vegetables', description: 'Chicken, Broccoli, Carrots, Rice', price: '$22' },
    { id: 7, image: 'https://preview.colorlib.com/theme/feliciano/images/insta-4.jpg', title: 'Pasta with tomato sauce', description: 'Pasta, Tomato Sauce, Basil, Parmesan', price: '$20' },
    { id: 8, image: 'https://preview.colorlib.com/theme/feliciano/images/insta-5.jpg', title: 'Grilled Beef with potatoes', description: 'Meat, Potatoes, Rice, Tomatoe', price: '$25' },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="md:grid grid-cols-1 md:grid-cols-4 gap-5">
          ...
          <div>
            ...
            <input type="email" placeholder="Enter Email address" className="bg-zinc-900 rounded-lg w-full p-2" />
            <input type="submit" value="Subscribe" className="bg-yellow-900 w-full rounded-lg mt-2 p-2" />
          </div>
        </div>
